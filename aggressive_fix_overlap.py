...
fig.suptitle('PRESTO: Privacy-Preserving Energy Data Analysis', 
             fontsize=22, fontweight='bold', y=0.95)  # Moved up more
plt.figtext(0.5, 0.91, 'Top-3 Unique Privacy Algorithms Evaluation and Comparison', 
...
plt.figtext(0.02, 0.12, ranking_text, fontsize=11,  # Moved down from 0.08 to 0.12
...
plt.figtext(0.98, 0.12, summary_text, fontsize=11, ha='right',  # Moved down from 0.08 to 0.12
